...
public class DocsConfig {
	...
	private static final String TITLE = "blogs - CORE - RESTful API";
	private static final String DESCRIPTION = "For blogs CORE purpose.<br/> It represents model of blogs, etc!";
